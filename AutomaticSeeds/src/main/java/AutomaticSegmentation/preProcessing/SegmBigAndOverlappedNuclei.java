 ...
 *
 */
public class SegmBigAndOverlappedNuclei implements genericSegmentation {
	...
	public SegmBigAndOverlappedNuclei(ImagePlus imp) {
		strelRadius2D = 2;
		strelRadius3D = 2;
	...
	public SegmBigAndOverlappedNuclei(ImagePlus imp, int radius2D, int radius3D, int tolerance) {
